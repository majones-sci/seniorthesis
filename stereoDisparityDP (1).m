% This code was obtained from Chris McCormick, "Stereo Vision Tutorial - Part I.” 
% [Online]. Available: https://mccormickml.com/2014/01/10/stereo-vision-tutorial-part-i/
% This code produces the improved disparity map shown in Iteration C.
